...
import style from './AccountantDash.module.scss'
...
const ClerkDash = () => {
    ...
    const tabBarItems = ['Orders'];
    const tabViews = [<ClientsSection/>];

  return (
    <div className={style['acc-dash']}>

        <Navbar profileToggleCallback={toggleProfileFloater} title="Accountant Dash"/>
